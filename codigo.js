...
const criarItemDeAtividade = (atividade) => {
  ...
  const textStyle = atividade.finalizada ? 'text-decoration: line-through;' : ''
  ...
  return `
    <div class="card-bg">
      ...
      <span style="${textStyle}">${atividade.nome}</span>
      </div>
      ...
      ${atividade.finalizada ? `<button style="${removeButtonStyle}" onclick="removerAtividade('${atividade.data}')"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
